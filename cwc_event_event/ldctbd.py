...
def tb_dense(dir_path):
    ...
    for line in tbd:
        ...
        if doc_id in test_files:
            if doc_id not in ettt:
                if ent1_id[0] == 't':
                    if ent2_id[0] == 't':
                        tt_count += 1
                        ettt[doc_id] = {(ent1_id, ent2_id):label_map[label]}
                    elif ent2_id[0] == 'e':
                        et_count += 1
                        ettt[doc_id] = {(ent1_id, ent2_id):label_map[label]}
                if ent1_id[0] == 'e' and ent2_id[0] == 't':
                    et_count += 1
                    ettt[doc_id] = {(ent1_id, ent2_id):label_map[label]}
            else:
                if ent1_id[0] == 't':
    ...
    out_path = str(dir_path) + "/caevo_test_ettt.pkl"
...
if __name__ == '__main__':
    ...
    args.out = Path('/nas/home/rujunhan/tbd_output/')
    print(args)
